              ...
              <table class="table align-items-center table-flush datatable">
                ...
                <tbody class="list">
                  ...
                  <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            <a class="btn btn-sm btn-icon-only text-primary" data-toggle="tooltip" href="{{ route('product.show', ['product' => $item->id]) }}" role="button" data-toggle="tooltip" aria-haspopup="true" aria-expanded="false">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a class="btn btn-sm btn-icon-only text-warning" data-toggle="tooltip" href="{{ route('product.edit', ['product' => $item->id]) }}" role="button" data-toggle="tooltip" aria-haspopup="true" aria-expanded="false">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="{{ route('product.destroy', ['product' => $item->id]) }}" method="POST">
                                @csrf
                                @method('delete')
                                <button type="submit" data-toggle="tooltip" class="btn btn-sm btn-icon-only text-danger btn-delete" data-name="{{ $item->nama_product }}"><i class="fas fa-trash"></i></button>
                            </form>
                        </div>
                    </td>
                    </td>
