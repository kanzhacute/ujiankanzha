              ...
              <table class="table align-items-center table-flush datatable">
                ...
                <tbody class="list">
                  ...
                  <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            <a class="btn btn-sm btn-icon-only text-primary" href="{{ route('user.show', ['user' => $user->id]) }}" role="button" data-toggle="tooltip" aria-haspopup="true" aria-expanded="false">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a class="btn btn-sm btn-icon-only text-warning" href="{{ route('user.edit', ['user' => $user->id]) }}" role="button" data-toggle="tooltip" aria-haspopup="true" aria-expanded="false">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="{{ route('user.destroy', ['user' => $user->id])}}" method="POST">
                                @csrf
                                @method('delete')
                                <button type="submit" class="btn btn-sm btn-icon-only text-danger btn-delete" data-name="{{ $user->name }}"><i class="fas fa-trash"></i></button>
                            </form>
                        </div>
                    </td>
                    </td>
