    ...
    <div class="container">
      ...
      <div class="navbar-collapse navbar-custom-collapse collapse" id="navbar-collapse">
        ...
        <ul class="navbar-nav mr-auto">
          <li class="nav-item">
            <a href="{{ route('home')}}" class="nav-link @if($route == 'home') text-brown active @endif">
              <span class="nav-link-inner--text">Home</span>
            </a>
          </li>
          <li class="nav-item">
            <a href="{{ route('produk')}}" class="nav-link @if($route == 'produk') text-brown active @endif">
              <span class="nav-link-inner--text">Product</span>
            </a>
          </li>
          <li class="nav-item">
            <a href="{{ route('contact.index')}}" class="nav-link @if($route == 'contact.index') text-brown active @endif">
      ...
      <div class="row align-items-center justify-content-xl-between">
        ...
        <div class="col-xl-6">
          <ul class="nav nav-footer justify-content-center justify-content-xl-end">
            <li class="nav-item">
                <a href="#" class="nav-link text-brown">Djiwa Sorria</a>
              </li>
              <li class="nav-item">
